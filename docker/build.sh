...
echo "  # -e NVIDIA_DISABLE_REQUIRE=1 은 호스트 드라이버가 보고하는 CUDA 가"
echo "  # 이미지의 CUDA 보다 낮을 때 필요하다 (docs/container.md 8절)."
echo "  docker run --rm -e NVIDIA_DISABLE_REQUIRE=1 --gpus \"\\\"device=\$G\\\"\" \\"
