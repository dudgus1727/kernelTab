...
GPU_PRESETS = {
    ...
    # ★ H100 은 변종마다 SM 수·클럭·대역폭이 다르다. 긴 키가 먼저 매칭되므로
    #   "h100 nvl" / "h100 pcie" 를 명시하지 않으면 **조용히 SXM 프리셋**이
    #   쓰인다 (H100 NVL: 132 SM / 6144-bit HBM3, PCIE: 114 SM / 5120-bit HBM2e).
    #   틀린 하드웨어 서술자로 뽑은 추천은 축 덮개 판정을 통째로 무의미하게 만든다.
    "h100 nvl": "H100_NVL", "h100 pcie": "H100_PCIE",
